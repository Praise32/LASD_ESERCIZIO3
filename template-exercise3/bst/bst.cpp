...
BST<Data>::BST(const TraversableContainer<Data>& var) {
  var.Traverse(
...
template <typename Data>
BST<Data>::BST(MappableContainer<Data>&& var) noexcept {
  var.Map(
    [this](const Data& value){
...
template<typename Data>
BST<Data>::BST(const BST<Data>& var): BinaryTreeLnk<Data>::BinaryTreeLnk(var) {;}

template<typename Data>
BST<Data>::BST(BST<Data>&& var) noexcept: BinaryTreeLnk<Data>::BinaryTreeLnk(std::move(var)) {;}


  /* ************************************************************************** */

template <typename Data>
BST<Data>& BST<Data>::operator=(const BST<Data>& var){
  BinaryTreeLnk<Data>::operator=(var);
  return *this;
}
template <typename Data>
BST<Data>& BST<Data>::operator=(BST<Data>&& var)noexcept{
  BinaryTreeLnk<Data>::operator=(std::move(var));
  return *this;
}

template <typename Data>
bool BST<Data>::operator==(const BST &var) const noexcept {
  if (size == var.Size()) {
    BTInOrderIterator<Data> IterThis(*this);
    BTInOrderIterator<Data> IterORight(var);
